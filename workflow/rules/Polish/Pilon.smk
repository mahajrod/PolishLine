...
rule pilon:
    ...
    params:
        fix_list=lambda wildcards: parse_option("fix_list",
                                                stage_dict[wildcards.stage]["parameters"][wildcards.prev_parameters + ".." + wildcards.polish_parameters]["option_set"] , " --fix "),
